                        ...
                        for best_trajectory in best_trajectory_event.read() {
                            ...
                            match pose_ref.channel_type() {
                                ChannelType::RotationX => {
                                    current_pose_rotation.x = start_pose_value
                                }
                                ChannelType::RotationY => {
                                    current_pose_rotation.y = start_pose_value
                                }
                                ChannelType::RotationZ => {
                                    current_pose_rotation.z = start_pose_value
                                }
                                ChannelType::PositionX => {
                                    current_pose_translation.x = start_pose_value
                                }
                                ChannelType::PositionY => {
                                    current_pose_translation.y = start_pose_value
                                }
                                ChannelType::PositionZ => {
                                    current_pose_translation.z = start_pose_value
                                }
                            }
